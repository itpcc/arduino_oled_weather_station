...
char* floatToChar(float n, char ch[]){
  int tmp;
  tmp = ((int)(n/10))%10;
  ch[0] = (tmp > 0)?('0'+tmp):' ';
  ch[1] = '0'+(((int)n)%10);
...
void loop()
{
  ...
  //LED_PrintBMP(0,0,128,7,(unsigned char *)test_3);
  char displayNum[5];
  int chk;
  displayNum[4] = '\0';
  ...
  //display
  LED_P8x16Str(10,3,floatToChar((float)DHT11.temperature, displayNum));
  LED_P8x16Str(70,3,floatToChar((float)DHT11.humidity, displayNum));
  LED_PrintBMP(0, 0, 128, (16 / 8) - 1, (unsigned char *)top_bar);
  LED_P6x8Char(20,6,'o');
  displayNum[0] = 'C'; displayNum[1] = '\0';
  LED_P8x16Str(28,6,displayNum); 
  displayNum[0] = '%'; LED_P8x16Str(84,6,displayNum);
